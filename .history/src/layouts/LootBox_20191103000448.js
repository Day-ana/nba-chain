...
export default function Admin({ ...rest }) {
  ...
  const revealLoot = e => {
    e.preventDefault();
    document.querySelector(".loot").classList.add("flip-scale-2-hor-top");
  };
          ...
          <GridContainer>
            <GridItem>
              ...
              <CardHeader color="success" stats icon>
                <img src=https://ak-static.cms.nba.com/wp-content/uploads/headshots/nba/latest/260x190/1626147.png className="loot"></img>
              </CardHeader>
              <CardBody>
                <button onClick={revealLoot}>Open</button>
                <p>Loot</p>
                Loot BOX
              </CardBody>
            </GridItem>
            {/* <GridItem>
              <CardHeader color="success" stats icon>
                <img src={lootbox} className="loot"></img>
              </CardHeader>
              <CardBody>
                <button onClick={revealLoot}>Open</button>
                <p>Loot</p>
